...
path_T5_base = "1anonymous1/MathSpeech_Ablation_Study_LaTeX_translator_T5_base"
...
for i in range(len(original)):
    ...
    result_list1.append(result_T5_base)
    print(f"result : {result_T5_base}")

df["MathSpeech_wo_corrector_T5base_result"] = result_list1
df.to_csv('MathSpeech_wo_corrector_T5base_result.csv', index=False)
