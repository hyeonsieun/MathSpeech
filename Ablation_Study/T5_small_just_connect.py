...
path_T5_small_1 = "1anonymous1/MathSpeech_Ablation_Study_Error_corrector_T5_small"
tokenizer_T5_small_l = T5Tokenizer.from_pretrained(path_T5_small_1)
model_T5_small_1 = T5ForConditionalGeneration.from_pretrained(path_T5_small_1)
model_T5_small_1.to(device)
model_T5_small_1.eval()

path_T5_small_2 = "1anonymous1/MathSpeech_Ablation_Study_LaTeX_translator_T5_small"
tokenizer_T5_small_2 = T5Tokenizer.from_pretrained(path_T5_small_2)
model_T5_small_2 = T5ForConditionalGeneration.from_pretrained(path_T5_small_2)
model_T5_small_2.to(device)
model_T5_small_2.eval()
...
for i in range(len(original)):
    ...
    T5_correct_raw = inference_correct(input, model_T5_small_1, tokenizer_T5_small_l)
    correct_result = postprocessing_T5(T5_correct_raw)
    print(f"correct_result : {correct_result}")
    raw_T5_small = inference_trans(correct_result, model_T5_small_2, tokenizer_T5_small_2)
...
df["MathSpeech_just_connect_T5small_result"] = result_list
df.to_csv('MathSpeech_just_connect_T5small_result.csv', index=False)